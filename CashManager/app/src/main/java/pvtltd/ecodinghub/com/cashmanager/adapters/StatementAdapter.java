...
public class StatementAdapter extends StatelessSection implements BottomSheetListener {
    /**
    ...
    public StatementAdapter(Context context, String tableName, Fragment fragment) {
        super(SectionParameters.builder()
                .itemResourceId(R.layout.listlayout)
    ...
    public void onBindItemViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (cursor.getCount() != 0) {
            ...
            itemViewHolder.amount.setText(String.valueOf(cursor.getInt(2)));
            holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    ...
                    new BottomSheet.Builder(context)
                            ...
                            .setListener(StatementAdapter.this)
                            .show();
                    return true;
                }
            });
