...
public class TablesAdapter extends RecyclerView.Adapter<TablesAdapter.CustomViewHolder> implements BottomSheetListener {
    ...
    public TablesAdapter(String tableName, Context context, Fragment income) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LinearLayout layout = (LinearLayout) LayoutInflater.from(parent.getContext()).inflate(R.layout.listlayout, parent, false);
            ...
            holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    ...
                    new BottomSheet.Builder(context)
                            ...
                            .setListener(TablesAdapter.this)
                            .show();
                    return true;
                }
            });
